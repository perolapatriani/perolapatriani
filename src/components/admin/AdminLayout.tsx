...
import { Building2, Sparkles, MapPin, MessageSquareQuote, FileText, LayoutDashboard, LogOut, Users, Home, Wand2, Contact, Megaphone, Plug } from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin/automacao", label: "Automação", icon: Megaphone },
